...
return e}function p(e){return h(c(je),e)}function d(e){e.transitionTo("deleted.saved"),e.send("invokeLifecycleCallbacks")}function f(e){}function m(e,t,r){e=h(t?Object.create(t):{},e),e.parentState=t,e.stateName=r
...
r===Ge&&(o="Invalid Document",s="/data"),t.push({title:o,detail:n[i],source:{pointer:s}})}}),t}function R(e){var t={}
return Ember.isPresent(e)&&e.forEach(function(e){if(e.source&&e.source.pointer){var r=e.source.pointer.match(qe)
r?r=r[2]:-1!==e.source.pointer.search(We)&&(r=Ge),r&&(t[r]=t[r]||[],t[r].push(e.detail||e.title))}}),t}function M(){this._super$constructor()}function A(e){switch(typeof e){case"object":return e
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function D(e,t){var r=e.inverseInternalModel
...
return H(t)&&(i=e.type.inverseFor(t.key,r)),i&&(n=i.name),"hasMany"===t.kind?new ot(r,e,n,t):new at(r,e,n,t)}function V(e){return Ember.get(e,"attributes").has("type")||Ember.get(e,"relationshipsByName").has("type")}function B(e){var t=void 0
return Ember.getOwner?t=Ember.getOwner(e):e.container&&(t=e.container),t&&t.lookupFactory&&!t._lookupFactory&&(t._lookupFactory=function(){var e
return(e=t).lookupFactory.apply(e,arguments)},t.register=function(){var e=t.registry||t._registry||t
return e.register.apply(e,arguments)}),t}function U(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
...
return u=T(u,t,"DS: Handle Adapter#findRecord of '"+a+"' with id: '"+n+"'"),u.then(function(i){var o=ee(t,e,a),s=Z(o,t,r,i,n,"findRecord")
...
return a=T(a,t,u),a.then(function(n){var i=ee(t,e,r),o=Z(i,t,s,n,null,"findMany")
...
return a=T(a,t,u),a=C(a,O(S,r)),a.then(function(r){var n=ee(t,e,i.type),o=Z(n,t,s,r,null,"findHasMany"),a=t._push(o)
...
return a=T(a,t,u),a=C(a,O(S,r)),a.then(function(r){var n=ee(t,e,i.type),o=Z(n,t,s,r,null,"findBelongsTo")
...
return u=T(u,t,"DS: Handle Adapter#findAll of "+o),u.then(function(n){var i=ee(t,e,r),a=Z(i,t,o,n,null,"findAll")
...
return e.query.length>3||e.query.wrappedFunction&&e.query.wrappedFunction.length>3?(i=i||t.recordArrayManager.createAdapterPopulatedRecordArray(r,n),a=Ember.RSVP.Promise.resolve().then(function(){return e.query(t,s,n,i,o)})):a=Ember.RSVP.Promise.resolve().then(function(){return e.query(t,s,n)}),a=T(a,t,"DS: Handle Adapter#query of "+r),a.then(function(o){var a=ee(t,e,r),u=Z(a,t,s,o,null,"query"),l=t._push(u)
...
return s=T(s,t,"DS: Handle Adapter#queryRecord of "+r),s.then(function(n){var i=ee(t,e,r),s=Z(i,t,o,n,null,"queryRecord")
...
for(var r in e)t[r]=e[r]
return t}function he(e){e.destroy()}function pe(e,t){var r=e.indexOf(t)
...
r._recordArrays.clear()}}function me(e,t){for(var r=0,n=e.length;r<n;r++){e[r]._recordArrays.add(t)}}function ve(e,t){return i(e.then(function(e){return e.getRecord()}),t)}function ye(e){return e.serializerFor("application")}function ge(e,t,r,n){var i=n._internalModel,o=n.modelName,s=t._modelFor(o),a=Ember.RSVP.Promise.resolve().then(function(){return e[r](t,s,n)}),u=ee(t,e,o),l="DS: Extract and notify about "+r+" completion of "+i
...
return p&&p._relationships.has(l)}function _e(e,t,r,n){Object.keys(r.relationships).forEach(function(i){var o=t._relationships
if(o.has(i)||be(e,t,r,i,n)){var s=r.relationships[i]
o.get(i).push(s,!1)}})}function we(e,t){var r=void 0,n=void 0
...
return Ember.computed({get:function(e){return this._internalModel._relationships.get(e).getData()},set:function(e,t){return this._internalModel.setDirtyHasMany(e,t),this._internalModel._relationships.get(e).getData()}}).meta(r)}function xe(e){var t=Object.create(null)
if(!e)return t
for(var r=e.split(Bt),n=0;n<r.length;n++){for(var i=r[n],o=0,s=!1;o<i.length;o++)if(58===i.charCodeAt(o)){s=!0
...
return(e=this._map).values.apply(e,arguments)},Me(e,[{key:"size",get:function(){return this._map.size}}]),e}(),Oe=Ember.ArrayProxy.extend(Ember.PromiseProxyMixin,{meta:Ember.computed.reads("content.meta")}),Ce=Ember.ObjectProxy.extend(Ember.PromiseProxyMixin),Se=Ce.extend({meta:Ember.computed(function(){}),reload:function(){return this.get("_belongsToState").reload(),this}}),Te=Oe.extend({reload:function(){return this.set("promise",this.get("content").reload()),this},createRecord:s("createRecord"),on:s("on"),one:s("one"),trigger:s("trigger"),off:s("off"),has:s("has")}),Pe=function(e){function t(t){var r=a(this,e.call(this))
...
return this.set(t,r),r},t}(Ae),ke=Ember.ArrayProxy.extend(Ember.Evented,{registerHandlers:function(e,t,r){this._registerHandlers(e,t,r)},_registerHandlers:function(e,t,r){this.on("becameInvalid",e,t),this.on("becameValid",e,r)},errorsByAttributeName:Ember.computed(function(){return new Pe({defaultValue:function(){return Ember.A()}})}),errorsFor:function(e){return Ember.get(this,"errorsByAttributeName").get(e)},messages:Ember.computed.mapBy("content","message"),content:Ember.computed(function(){return Ember.A()}),unknownProperty:function(e){var t=this.errorsFor(e)
...
var ze=p({dirtyType:"updated"})
Ne.uncommitted.deleteRecord=d,Ne.invalid.deleteRecord=d,Ne.uncommitted.rollback=function(e){je.uncommitted.rollback.apply(this,arguments),e.transitionTo("deleted.saved")},Ne.uncommitted.pushedData=function(e){e.transitionTo("loaded.updated.uncommitted"),e.triggerLater("didLoad")},Ne.uncommitted.propertyWasReset=function(){},ze.invalid.becameValid=function(e){e.transitionTo("loaded.saved")},ze.inFlight.unloadRecord=f,ze.uncommitted.deleteRecord=function(e){e.transitionTo("deleted.uncommitted")},ze.invalid.rolledBack=function(e){e.clearErrorMessages(),e.transitionTo("loaded.saved"),e.triggerLater("rolledBack")}
var Le={isEmpty:!1,isLoading:!1,isLoaded:!1,isDirty:!1,isSaving:!1,isDeleted:!1,isNew:!1,isValid:!0,rolledBack:function(){},unloadRecord:function(e){},propertyWasReset:function(){},empty:{isEmpty:!0,loadingData:function(e,t){e._promiseProxy=t,e.transitionTo("loading")},loadedData:function(e){e.transitionTo("loaded.created.uncommitted"),e.triggerLater("ready")},pushedData:function(e){e.transitionTo("loaded.saved"),e.triggerLater("didLoad"),e.triggerLater("ready")}},loading:{isLoading:!0,exit:function(e){e._promiseProxy=null},pushedData:function(e){e.transitionTo("loaded.saved"),e.triggerLater("didLoad"),e.triggerLater("ready"),e.didCleanError()},becameError:function(e){e.triggerLater("becameError",e)},notFound:function(e){e.transitionTo("empty")}},loaded:{initialState:"saved",isLoaded:!0,loadingData:function(){},saved:{setup:function(e){e.hasChangedAttributes()&&e.adapterDidDirty()},didSetProperty:l,pushedData:function(){},becomeDirty:function(e){e.transitionTo("updated.uncommitted")},willCommit:function(e){e.transitionTo("updated.inFlight")},reloadRecord:function(e,t){var r=t.resolve,n=t.options
r(e.store._reloadRecord(e,n))},deleteRecord:function(e){e.transitionTo("deleted.uncommitted")},unloadRecord:function(e){},didCommit:function(){},notFound:function(){}},created:Ne,updated:ze},deleted:{initialState:"uncommitted",dirtyType:"deleted",isDeleted:!0,isLoaded:!0,isDirty:!0,setup:function(e){e.updateRecordArrays()},uncommitted:{willCommit:function(e){e.transitionTo("inFlight")},rollback:function(e){e.rollbackAttributes(),e.triggerLater("ready")},pushedData:function(){},becomeDirty:function(){},deleteRecord:function(){},rolledBack:function(e){e.transitionTo("loaded.saved"),e.triggerLater("ready"),e.triggerLater("rolledBack")}},inFlight:{isSaving:!0,unloadRecord:f,willCommit:function(){},didCommit:function(e){e.transitionTo("saved"),e.send("invokeLifecycleCallbacks")},becameError:function(e){e.transitionTo("uncommitted"),e.triggerLater("becameError",e)},becameInvalid:function(e){e.transitionTo("invalid"),e.triggerLater("becameInvalid",e)}},saved:{isDirty:!1,setup:function(e){e.removeFromInverseRelationships()},invokeLifecycleCallbacks:function(e){e.triggerLater("didDelete",e),e.triggerLater("didCommit",e)},willCommit:function(){},didCommit:function(){},pushedData:function(){}},invalid:{isValid:!1,didSetProperty:function(e,t){e.removeErrorMessageFromAttribute(t.name),l(e,t),e.hasErrors()||this.becameValid(e)},becameInvalid:function(){},becomeDirty:function(){},deleteRecord:function(){},willCommit:function(){},rolledBack:function(e){e.clearErrorMessages(),e.transitionTo("loaded.saved"),e.triggerLater("ready")},becameValid:function(e){e.transitionTo("uncommitted")}}},invokeLifecycleCallbacks:function(e,t){"created"===t?e.triggerLater("didCreate",e):e.triggerLater("didUpdate",e),e.triggerLater("didCommit",e)}},Ie=m(Le,null,"root"),De=Ember.computed(function(){var e=new Pe({defaultValue:function(){return[]}})
return this.eachComputedProperty(function(t,r){if(r.isRelationship){r.key=t
e.get(y(r)).push({name:t,kind:r.kind})}}),e}).readOnly(),He=Ember.computed(function(){var e=void 0,t=Ember.A()
return this.eachComputedProperty(function(r,n){n.isRelationship&&(n.key=r,e=y(n),t.includes(e)||t.push(e))}),t}).readOnly(),Fe=Ember.computed(function(){var e=new Ae
return this.eachComputedProperty(function(t,r){if(r.isRelationship){r.key=t
var n=g(r)
n.type=y(r),e.set(t,n)}}),e}).readOnly(),Ve=Ember.changeProperties,Be=Ember.computed("currentState",function(e){return Ember.get(this._internalModel.currentState,e)}).readOnly(),Ue=Ember.Object.extend(Ember.Evented,{_internalModel:null,store:null,__defineNonEnumerable:function(e){this[e.name]=e.descriptor.value},isEmpty:Be,isLoading:Be,isLoaded:Be,hasDirtyAttributes:Ember.computed("currentState.isDirty",function(){return this.get("currentState.isDirty")}),isSaving:Be,isDeleted:Be,isNew:Be,isValid:Be,dirtyType:Be,isError:!1,isReloading:!1,currentState:Ie.empty,errors:Ember.computed(function(){var e=ke.create()
...
Object.defineProperty(Ue.prototype,"data",{configurable:!1,get:function(){return this._internalModel._data}}),Object.defineProperty(Ue.prototype,"id",{configurable:!1,set:function(e){this._internalModel.setId(e)},get:function(){return this._internalModel&&this._internalModel.id}}),Ue.reopenClass({isModel:!0,modelName:null,typeForRelationship:function(e,t){var r=Ember.get(this,"relationshipsByName").get(e)
...
return e===n.inverse})
1===l.length&&(u=l),o=u[0].name,s=u[0].kind}return{type:r,name:o,kind:s}},relationships:De,relationshipNames:Ember.computed(function(){var e={hasMany:[],belongsTo:[]}
return this.eachComputedProperty(function(t,r){r.isRelationship&&e[r.kind].push(t)}),e}),relatedTypes:He,relationshipsByName:Fe,fields:Ember.computed(function(){var e=new Ae
...
var qe=/^\/?data\/(attributes|relationships)\/(.*)/,We=/^\/?data/,Ge="base"
_.prototype=Object.create(Ember.Error.prototype),_.extend=w(_)
var Ke=E(_,"The adapter rejected the commit because it was invalid"),$e=E(_,"The adapter operation timed out"),Ye=E(_,"The adapter operation was aborted"),Qe=E(_,"The adapter operation is unauthorized"),Xe=E(_,"The adapter operation is forbidden"),Je=E(_,"The adapter could not find the resource"),Ze=E(_,"The adapter operation failed due to a conflict"),et=E(_,"The adapter operation failed due to a server error")
...
this.members=new M,this.canonicalMembers=new M,this.store=e,this.key=n.key,this.inverseKey=r,this.internalModel=t,this.isAsync=void 0===i||i,this.isPolymorphic=void 0!==o&&o,this.relationshipMeta=n,this.inverseKeyForImplicit=this.internalModel.modelName+this.key,this.fetchPromise=null,this._promiseProxy=null,this.meta=null,this.__inverseMeta=void 0,this.shouldForceReload=!1,this.relationshipIsStale=!this.isNew,this.hasAnyRelationshipData=!1,this.relationshipIsEmpty=!0,this.hasFailedLoadAttempt=!1}return e.prototype._inverseIsSync=function(){var e=this._inverseMeta
if(!e)return!1
...
if(e.meta&&this.updateMeta(e.meta),void 0!==e.data?(r=!0,this.updateData(e.data,t)):void 0!==e._partialData&&this.updateData(e._partialData,t),e.links&&e.links.related){var i=A(e.links.related)
...
r=this.link?this._fetchLink():this._fetchRecords(),r=r.then(function(){return N(e)},function(t){return N(e,t)}),this.fetchPromise=r,this._updateLoadingPromise(r,t)}return this.isAsync?(null===this._promiseProxy&&this._updateLoadingPromise(Ember.RSVP.resolve(t),t),this._promiseProxy):t},t.prototype.notifyHasManyChanged=function(){this.internalModel.notifyHasManyAdded(this.key)},t.prototype.updateData=function(e,t){var r=this.store._pushResourceIdentifiers(this,e)
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),at=function(e){function t(t,r,n,i){var o=L(this,e.call(this,t,r,n,i))
...
if(this.shouldMakeRequest()){var r=void 0
r=this.link?this._fetchLink():this._fetchRecord(),r=r.then(function(){return D(e)},function(t){return D(e,t)}),r=r.then(function(e){return e?e.getRecord():null}),this.fetchPromise=r,this._updateLoadingPromise(r)}if(this.isAsync){if(null===this._promiseProxy){var n=Ember.RSVP.resolve(this.inverseInternalModel).then(function(e){return e?e.getRecord():null})
this._updateLoadingPromise(n,t)}return this._promiseProxy}return t},t.prototype._createProxy=function(e,t){return Se.create({_belongsToState:this,promise:e,content:t})},t.prototype.updateData=function(e,t){var r=this.store._pushResourceIdentifier(this,e)
...
r=t[e]=F(n,o,n.store),s&&r.push(s,!0)}return r},ut(e,[{key:"record",get:function(){return this.internalModel}}]),e}(),ct=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r]
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),ht=function(){function e(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
e=this.__attributes=Object.create(null),t.eachAttribute(function(r){return e[r]=Ember.get(t,r)})}return e}},{key:"type",get:function(){return this._internalModel.modelClass}}]),e}(),pt=function(e,t){this.store=e,this.internalModel=t}
pt.prototype={constructor:pt}
var dt=function(e){function t(t,r){var n=U(this,e.call(this,t,r))
return n.type=r.modelName,n._id=r.id,n}return q(t,e),t.prototype.id=function(){return this._id},t.prototype.remoteType=function(){return"identity"},t.prototype.push=function(e){var t=this
...
return e?e.reload():this.load()},t}(pt),ft=function(e){function t(t,r,n){var i=W(this,e.call(this,t,r))
...
return r=e instanceof Ue?e:t.store.push(e),t.belongsToRelationship.setCanonicalInternalModel(r._internalModel),r})},t.prototype.value=function(){var e=this.belongsToRelationship.inverseInternalModel
...
return this.belongsToRelationship.reload().then(function(t){return e.value()})},t}(pt),mt=function(e){function t(t,r,n){var i=K(this,e.call(this,t,r))
...
break
default:t[s]=u}else this.setId(u)}Ember.setOwner?Ember.setOwner(t,B(this.store)):t.container=this.store.container,this._record=this.store.modelFactoryFor(this.modelName).create(t),this._triggerDeferredTriggers()}return this._record},e.prototype.getFields=function(){return Ember.get(this.modelClass,"fields")},e.prototype.resetRecord=function(){this._record=null,this.isReloading=!1,this.error=null,this.currentState=Ie.empty,this.__attributes=null,this.__inFlightAttributes=null,this._data=null},e.prototype.dematerializeRecord=function(){this._record&&(this._isDematerializing=!0,this._record.destroy(),this.destroyRelationships(),this.resetRecord()),this.updateRecordArrays()},e.prototype.deleteRecord=function(){this.send("deleteRecord")},e.prototype.save=function(e){var t="DS: Model#save "+this,r=Ember.RSVP.defer(t)
...
return this._relationships.forEach(function(t,r){e=e.concat(r.members.list,r.canonicalMembers.list)}),e},e.prototype._allRelatedInternalModels=function(){var e=[],t=[],r=wt++
...
return t!==r&&(this._attributes[e]=t,n=e in this._inFlightAttributes?this._inFlightAttributes[e]:this._data[e],this.send("didSetProperty",{name:e,oldValue:r,originalValue:n,value:t})),t},e.prototype.createSnapshot=function(e){return new ht(this,e)},e.prototype.loadingData=function(e){this.send("loadingData",e)},e.prototype.loadedData=function(){this.send("loadedData")},e.prototype.notFound=function(){this.send("notFound")},e.prototype.pushedData=function(){this.send("pushedData")},e.prototype.flushChangedAttributes=function(){this._inFlightAttributes=this._attributes,this._attributes=null},e.prototype.hasChangedAttributes=function(){return null!==this.__attributes&&Object.keys(this.__attributes).length>0},e.prototype.updateChangedAttributes=function(){for(var e=this.changedAttributes(),t=Object.keys(e),r=this._attributes,n=0,i=t.length;n<i;n++){var o=t[n],s=e[o]
...
var i=void 0,o=void 0,s=void 0,a=void 0,u=yt[n]
if(u)i=u.setups,o=u.enters,r=u.state
else{i=[],o=[]
var l=Y(e)
for(s=0,a=l.length;s<a;s++)r=r[l[s]],r.enter&&o.push(r),r.setup&&i.push(r)
yt[n]={setups:i,enters:o,state:r}}for(s=0,a=o.length;s<a;s++)o[s].enter(this)
...
this._models=[]
for(var t=0;t<e.length;t++){e[t].unloadRecord()}this._metadata=null},xt(e,[{key:"length",get:function(){return this._models.length}},{key:"models",get:function(){return this._models}},{key:"metadata",get:function(){return this._metadata||(this._metadata=Object.create(null))}},{key:"type",get:function(){throw new Error("InternalModelMap.type is no longer available")}}]),e}(),Mt=function(){function e(){this._map=Object.create(null)}return e.prototype.retrieve=function(e){var t=this._map[e]
...
return null!==e&&"hasMany"===e.kind}}]),e}(),St=function(){function e(e){this._store=e,this._cache=Object.create(null),this._inverseLookupCache=new Ot}return e.prototype.get=function(e,t,r){var n=this._getRelationshipPayloads(e,r,!1)
...
return!0===e.hasInverse&&(this._cache[r]=i),i},e}(),Tt=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r]
...
r&&r.delete(e)})},_unregisterFromManager:function(){this.manager.unregisterRecordArray(this)},willDestroy:function(){this._unregisterFromManager(),this._dissociateFromOwnRecords(),Ember.set(this,"content",null),Ember.set(this,"length",0),this._super.apply(this,arguments)},_createSnapshot:function(e){return new Pt(this,this.get("meta"),e)},_takeSnapshot:function(){return Ember.get(this,"content").map(function(e){return e.createSnapshot()})}}),jt=kt.extend({init:function(){this.set("content",this.get("content")||Ember.A()),this._super.apply(this,arguments),this.query=this.query||null,this.links=this.links||null},replace:function(){throw new Error("The result of a server query (on "+this.modelName+") is immutable.")},_update:function(){var e=Ember.get(this,"store"),t=Ember.get(this,"query")
return e._query(this.modelName,t,this)},_setInternalModels:function(e,t){this.get("content").setObjects(e),this.setProperties({isLoaded:!0,isUpdating:!1,meta:ce(t.meta),links:ce(t.links)}),me(e,this),Ember.run.once(this,"trigger","didLoad")}}),Nt=Ember.run.backburner,zt=function(){function e(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._liveRecordArrays=Object.create(null),this._pending=Object.create(null),this._adapterPopulatedRecordArrays=[]}return e.prototype.recordDidChange=function(e){this.internalModelDidChange(e)},e.prototype.recordWasLoaded=function(e){this.internalModelDidChange(e)},e.prototype.internalModelDidChange=function(e){var t=e.modelName
...
!1===i.isHiddenFromRecordArrays()&&r.push(i)}return r},e.prototype.createRecordArray=function(e,t){var r=kt.create({modelName:e,content:Ember.A(t||[]),store:this.store,isLoaded:!0,manager:this})
return Array.isArray(t)&&me(t,r),r},e.prototype.createAdapterPopulatedRecordArray=function(e,t,r,n){var i=void 0
return Array.isArray(r)?(i=jt.create({modelName:e,query:t,content:Ember.A(r),store:this.store,manager:this,isLoaded:!0,isUpdating:!1,meta:ce(n.meta),links:ce(n.links)}),me(r,i)):i=jt.create({modelName:e,query:t,content:Ember.A(),store:this.store,manager:this}),this._adapterPopulatedRecordArrays.push(i),i},e.prototype.unregisterRecordArray=function(e){var t=e.modelName
...
Object.keys(this._liveRecordArrays).forEach(function(t){return e._liveRecordArrays[t].destroy()}),this._adapterPopulatedRecordArrays.forEach(he),this.isDestroyed=!0},e.prototype.destroy=function(){this.isDestroying=!0,Nt.schedule("actions",this,this.willDestroy)},e}(),Lt=new Ember._Backburner(["normalizeRelationships","syncRelationships","finished"]),It=Ember.run.backburner,Dt=void 0
Dt=Ember.Service.extend({init:function(){this._super.apply(this,arguments),this._backburner=Lt,this.recordArrayManager=new zt({store:this}),this._identityMap=new Mt,this._pendingSave=[],this._modelFactoryCache=Object.create(null),this._relationshipsPayloads=new St(this),this._pendingSave=[],this._updatedRelationships=[],this._pushedInternalModels=[],this._updatedInternalModels=[],this._pendingFetch=new Pe({defaultValue:function(){return[]}}),this._adapterCache=Object.create(null),this._serializerCache=Object.create(null)},adapter:"-json-api",serialize:function(e,t){return e._internalModel.createSnapshot().serialize(t)},defaultAdapter:Ember.computed("adapter",function(){var e=Ember.get(this,"adapter")
return this.adapterFor(e)}),createRecord:function(e,t){var r=this
return It.join(function(){return r._backburner.join(function(){var n=v(e),i=Ember.assign({},t)
...
x[R]=M,E[R]=M.id}if(w>1)(function(e){ne(s,o,t,E,e).then(function(t){n(t,e)}).catch(function(t){i(e,t)})})(x)
...
this.adapterFor(r)
return this._scheduleFetch(e,t)},hasRecordForId:function(e,t){var r=v(e),n=le(t),i=this._internalModelsFor(r).get(n)
...
return o(ae(i,this,e,t,r,n))},queryRecord:function(e,t,r){var n=v(e),o=this.adapterFor(n),s={}
return r&&r.adapterOptions&&(s.adapterOptions=r.adapterOptions),i(ue(o,this,e,t,s).then(function(e){return e?e.getRecord():null}))},findAll:function(e,t){var r=v(e)
...
e.flushChangedAttributes(),e.adapterWillCommit(),this._pendingSave.push({snapshot:n,resolver:t}),It.scheduleOnce("actions",this,this.flushPendingSave)},flushPendingSave:function(){var e=this._pendingSave.slice()
this._pendingSave=[]
...
return r.setupData(e),n?this.recordArrayManager.recordDidChange(r):this.recordArrayManager.recordWasLoaded(r),r},_modelForMixin:function(e){var t=B(this),r=void 0
...
var r=B(this).factoryFor?t.class:t
r.modelName&&r.hasOwnProperty("modelName")||(r.modelName=e),this._modelFactoryCache[e]=t}return t},modelFactoryFor:function(e){var t=v(e),r=B(this)
...
return o}return null===e.data?null:t._pushInternalModel(e.data)})},_hasModelFor:function(e){var t=B(this)
...
if(t){n=t
var i=v(e)
r=this.serializerFor(i)}else n=e,r=ye(this)
...
return r}}})
var Ht=Dt,Ft=Ember.Namespace.create({VERSION:n,name:"DS"})
Ember.libraries&&Ember.libraries.registerCoreLibrary("Ember Data",Ft.VERSION)
var Vt=Ember.Mixin.create({buildURL:function(e,t,r,n,i){switch(n){case"findRecord":return this.urlForFindRecord(t,e,r)
...
return t.pluralize(r)}}),Bt=/\r?\n/,Ut=Ember.DataAdapter.extend({getFilters:function(){return[{name:"isNew",desc:"New"},{name:"isModified",desc:"Modified"},{name:"isClean",desc:"Clean"}]},detect:function(e){return e!==Ue&&Ue.detect(e)},columnsForType:function(e){var t=[{name:"id",desc:"Id"}],r=0,n=this
...
e.Model=Ue,e.Errors=ke,e.Store=Ht,e.DS=Ft,e.belongsTo=we,e.hasMany=Ee,e.BuildURLMixin=Vt,e.Snapshot=ht,e.AdapterError=_,e.InvalidError=Ke,e.UnauthorizedError=Qe,e.ForbiddenError=Xe,e.NotFoundError=Je,e.ConflictError=Ze,e.ServerError=et,e.TimeoutError=$e,e.AbortError=Ye,e.errorsHashToArray=x,e.errorsArrayToHash=R,e.normalizeModelName=v,e.getOwner=B,e.modelHasAttributeOrRelationshipNamedType=V,e.coerceId=le,e.parseResponseHeaders=xe,e.isEnabled=Re,e.RootState=Ie,e.InternalModel=Et,e.PromiseArray=Oe,e.PromiseObject=Ce,e.PromiseManyArray=Te
e.RecordArray=kt,e.AdapterPopulatedRecordArray=jt,e.ManyArray=nt,e.RecordArrayManager=zt,e.Relationship=rt,e.Map=Ae,e.MapWithDefault=Pe,e.DebugAdapter=Ut,e.diffArray=P,e.RelationshipPayloadsManager=St,e.RelationshipPayloads=Ct,e.SnapshotRecordArray=Pt,Object.defineProperty(e,"__esModule",{value:!0})}),define("ember-data/adapter",["exports"],function(e){"use strict"
...
function t(e){return Ember.Helper?Ember.Helper.helper(e):Ember.HTMLBars?Ember.HTMLBars.makeBoundHelper(e):Ember.Handlebars.makeBoundHelper(e)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=t}),define("ember-keyboard-shortcuts/create-mixin",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default={content:'<path fill-rule="evenodd" d="M9 0H1C.27 0 0 .27 0 1v15l5-3.09L10 16V1c0-.73-.27-1-1-1zm-.78 4.25L6.36 5.61l.72 2.16c.06.22-.02.28-.2.17L5 6.6 3.12 7.94c-.19.11-.25.05-.2-.17l.72-2.16-1.86-1.36c-.17-.16-.14-.23.09-.23l2.3-.03.7-2.16h.25l.7 2.16 2.3.03c.23 0 .27.08.09.23h.01z"/>',attrs:{xmlns:"http://www.w3.org/2000/svg",width:"10",height:"16",viewBox:"0 0 10 16"}}})
define("ember-svg-jar/inlined/briefcase",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default={content:'<path fill-rule="evenodd" d="M13 1H1c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V2c0-.55-.45-1-1-1zm0 13H1V2h12v12zM6 9H3V7h3V4h2v3h3v2H8v3H6V9z"/>',attrs:{xmlns:"http://www.w3.org/2000/svg",width:"14",height:"16",viewBox:"0 0 14 16"}}})
define("ember-svg-jar/inlined/diff-ignored",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default={content:'<path fill-rule="evenodd" d="M8 4v1H0V4h8zM0 8h8V7H0v1zm0 3h8v-1H0v1z"/>',attrs:{xmlns:"http://www.w3.org/2000/svg",width:"8",height:"16",viewBox:"0 0 8 16"}}})
define("ember-svg-jar/inlined/graph",["exports"],function(e){"use strict"
...
define("ember-svg-jar/inlined/markdown",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default={content:'<path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/>',attrs:{xmlns:"http://www.w3.org/2000/svg",width:"10",height:"16",viewBox:"0 0 10 16"}}})
define("ember-svg-jar/inlined/repo-pull",["exports"],function(e){"use strict"
...
define("ember-svg-jar/inlined/triangle-down",["exports"],function(e){"use strict"
